...
# выбрасывать исключение Exception с содержанием <l> != <r> , где <l> и <r> строки, которые хранятся в переменных left и right соответственно.
...
def EnsureEqual(left :str, right :str):
    if left != right:
        raise Exception("{} != {}".format(left, right))